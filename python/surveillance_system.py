...
SM = StorageManager(work_in_dir='../bin/storage', interval=3000, space = 5, critical_space=2)

def clean_storage():
    print("STORAGE MANAGER THREAD")
    while True:
        SM.reduce_files()
...
def filtering():
    SystemFiltering.start(filter_interval=1000)
